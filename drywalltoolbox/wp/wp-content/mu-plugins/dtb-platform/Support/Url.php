 ...
 *
 * Production checkout is a full-document WooCommerce page, while staging may
 * preserve a public `/staging/{id}` prefix for checkout/order URLs. Detection is
 * conservative and never grants authorization; it is URL presentation metadata.
 *
 * @return string Example: `/staging/2972`, or an empty string at production root.
 */
 ...
 * @return string Example: `/staging/2972`, or empty for production root.
 */
 ...
 * @param string $base_path Example: `/staging/2972`; empty is a no-op.
 */
