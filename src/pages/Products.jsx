  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {isModalOpen && modalProduct && (
        <div className="fixed inset-0 z-[1100] flex items-center justify-center p-0 sm:p-4 overflow-hidden">
          ...
          <div className="relative w-full h-full sm:h-auto max-w-full sm:max-w-3xl md:max-w-5xl lg:max-w-6xl mx-auto overflow-x-hidden">
